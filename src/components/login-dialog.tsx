      ...
      <DialogContent 
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 gap-2">
            <Button onClick={handleGoogleSignIn} variant="secondary" className="bg-secondary/50 hover:bg-secondary/80">
              <svg className="mr-2 h-4 w-4" viewBox="0 0 48 48">
                  ...
                  <path fill="#1976D2" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,35.636,44,29.8,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
              </svg>
              Google
            </Button>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-2 text-center">
            <Button variant="link" className="text-xs text-muted-foreground" onClick={handleGuestSignIn}>
              Continue as Guest
            </Button>
          </motion.div>
        </motion.div>
